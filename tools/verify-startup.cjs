...
assert(index.includes('responsive-desktop.css?v=23'),
...
assert(shellJs.includes("desktop.href='responsive-desktop.css?v=23'"),
...
assert(desktopCss.includes('.enemy-unit>#intent{position:fixed!important;left:65vw!important')&&desktopCss.includes('.enemy-unit.elite-unit>#intent{left:63vw!important}')&&desktopCss.includes('.enemy-unit.boss-unit>#intent{left:59vw!important}')&&desktopCss.includes('top:35vh!important')&&desktopCss.includes('transform:translate(-100%,-100%)!important'),
...
async function verifyServer(){
 ...
 try{
  ...
  assert(html.includes('responsive-desktop.css?v=23'),'served page has no PC layout stylesheet');
