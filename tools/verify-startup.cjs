...
assert(index.includes('responsive-desktop.css?v=22'),
...
assert(shellJs.includes("desktop.href='responsive-desktop.css?v=22'"),
...
async function verifyServer(){
 ...
 try{
  ...
  assert(html.includes('responsive-desktop.css?v=22'),'served page has no PC layout stylesheet');
