...
assert(desktopCss.includes('.enemy-unit>#intent{position:fixed!important')&&desktopCss.includes('left:59vw!important')&&desktopCss.includes('top:35vh!important')&&desktopCss.includes('transform:translate(-100%,-100%)!important'),
