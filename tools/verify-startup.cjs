...
assert(index.includes('responsive-desktop.css?v=34'),
...
assert(shellJs.includes("desktop.href='responsive-desktop.css?v=34'")&&shellJs.includes("link.href='responsive-landscape.css?v=48'"),
...
assert(desktopCss.includes('tv-fixed-canvas #battle .enemy-unit>#intent{left:1024px!important;top:243px!important}')&&desktopCss.includes('tv-fixed-canvas #battle .enemy-unit.elite-unit>#intent{left:992px!important}')&&desktopCss.includes('tv-fixed-canvas #battle .enemy-unit.boss-unit>#intent{left:896px!important}'),
...
async function verifyServer(){
 ...
 try{
  ...
  assert(html.includes('responsive-shell.js?v=52'),'served page has a stale responsive script version');
  assert(html.includes('responsive-landscape.css?v=48'),'served page has a stale responsive stylesheet version');
  assert(html.includes('responsive-desktop.css?v=34'),'served page has no PC layout stylesheet');
