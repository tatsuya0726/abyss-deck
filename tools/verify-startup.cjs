...
assert(index.includes('responsive-desktop.css?v=15'),
...
assert(shellJs.includes("desktop.href='responsive-desktop.css?v=15'"),
...
async function verifyServer(){
 ...
 try{
  ...
  assert(html.includes('responsive-desktop.css?v=15'),'served page has no PC layout stylesheet');
