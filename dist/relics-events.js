...
const RELICS={
 ...
 '深海の血脈':['🩹','戦闘に勝利するたびHPを5回復する。'],
 '分厚い甲殻':['🐢','ターン開始時、ブロックを最大6引き継ぐ（残りは失う）。'],
 '警鐘の巻貝':['🔔','各戦闘で最初にHPを失った時、カードを2枚引く。'],
 '深海の呼吸':['🐬','毎ターン、カードを追加で1枚引く。'],
...
const BOSS_RELICS={
 ...
 '四皇の王冠':['🫅','毎ターンのエナジー＋1。ただし、毎ターンのドロー枚数が4枚固定になる（カード効果では増やせる）。'],
