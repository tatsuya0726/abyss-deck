...
const RELICS={
 ...
 '沈黙の錨':['⚓','手札が0枚の状態でターンを終えると、次のターンのエナジー＋1。','uncommon'],
...
const BOSS_RELICS={
 ...
 '永久潮汐機関':['♾️','余ったエナジーを最大2まで次のターンへ持ち越す。ただし、毎ターン引けるカードが1枚少なくなる。','boss'],
 '喰らう海溝':['🕳️','各ターン最初にカードを廃棄すると、カードを1枚引き、エナジー＋1。ただし、戦闘開始時に手札へ呪いを1枚追加する。','boss']
};
