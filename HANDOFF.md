...
- 贈り物と単一結果画面では、ふりがなを本文幅の計算から外して真上に配置し、文章のガタつきを解消
- 黄色背景だけふりがなを黒字にし、暗い背景は従来の水色へ復元
- 単一結果の「ゴールド＋60」など効果本文を拡大
- 効果が1件だけの結果画面を、内容に合う中央のコンパクトなウィンドウへ変更
- 現在のキャッシュ番号: `responsive-landscape.css?v=49`、`responsive-desktop.css?v=5`、`responsive-shell.js?v=40`
